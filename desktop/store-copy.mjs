...
用户尚无 Steamworks 账号/AppID。下一步由用户完成 Steamworks 开户、身份/税务/收款信息和 Steam Direct 费用；取得主游戏 AppID 后创建关联 Playtest AppID。Playtest 是免费测试，不是付费 Early Access；测试报名显示在主游戏商店页。

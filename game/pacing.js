...
import {economyEnabled,fixedRaise} from './table-rewards.js';
export const tableStake = round => round >= 5 ? 12 : 8;
export const targetFactor=s=>growthRaise(s,1)+skipTargetPenalty(s);
export const targetSurcharge = s => stageRaise(s) + (economyEnabled(s)?fixedRaise(s.round+1):(s.round === 1 && !s.practice ? 4 : 0));

...
export const ROUTES = {
  raw: { type: 'enchant', name: ['生腌小摊', 'Raw bar'], text: ['给1张食材附魔「生腌」。', 'Give one food the Raw enchantment.'], icon: 'fish' },
  fried: { type: 'enchant', name: ['油炸小摊', 'Fry stand'], text: ['给1张食材附魔「油炸」。', 'Give one food the Fried enchantment.'], icon: 'stove' },
  boiled: { type: 'enchant', name: ['水煮小摊', 'Boiling pot'], text: ['给1张食材附魔「水煮」。', 'Give one food the Boiled enchantment.'], icon: 'tea' },

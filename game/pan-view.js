...
export function panEncounterHTML(s,lang='zh',busy=false){
 const en=lang==='en',tr=(a,b)=>en?b:a,e=s.encounter,price=e.quote,short=Math.max(0,price-s.bank);
 const line=!e.haggled?tr('“五十。杯子归你。再摸到炸弹，它替你挨这一下。”','“Fifty. The cup is yours. Next bomb you draw, it takes the hit.”'):price===25?tr('“二十五。钱放这儿，别让他碰。”','“Twenty-five. Put it here. Keep it away from him.”'):tr('“一百。刚才五十的时候，你没买。”','“A hundred. You had your chance at fifty.”');
